...
const DEFAULT_CONFIG = {
  providers: [
    ...
    { id: 'nousresearch', name: 'Nous Portal', type: 'openai', baseUrl: 'https://inference-api.nousresearch.com/v1', auth: 'key', removable: false, hint: 'Your Nous Portal subscription authenticates with an API key. Generate one at portal.nousresearch.com → API Keys and paste it here.' }
  ],
  keys: {},
  oauth: {},
  mcpServers: [],
